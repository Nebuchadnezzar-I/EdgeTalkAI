		...
		>
			...
			<div class="form-control w-full">
				<label class="label cursor-pointer">
					<span class="label-text text-xl font-semibold">English (US)</span>
					<input
						checked
						class="checkbox border-none bg-transparent"
						type="radio"
						name="selection"
					/>
				</label>
			...
			<div class="form-control w-full">
				<label class="label cursor-pointer">
					<span class="label-text text-xl font-semibold">English (UK)</span>
					<input
						checked
						class="checkbox border-none bg-transparent"
						type="radio"
			...
			<div class="divider divider-start opacity-60">Language</div>

			{#each Object.entries(languages) as item}
				<div class="form-control w-full">
					<label class="label cursor-pointer">
						<span
							class="
                            label-text max-w-[80%] overflow-hidden
